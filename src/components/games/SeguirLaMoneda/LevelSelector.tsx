            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isUnlocked 
                    ? 'bg-yellow-50 text-yellow-600 hover:bg-yellow-500 hover:text-white cursor-pointer shadow-md hover:shadow-yellow-200 scale-100 hover:scale-105 active:scale-95' 
